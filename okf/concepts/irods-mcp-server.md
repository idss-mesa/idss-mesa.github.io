...
description: "Reference MCP server for the CyVerse Data Store (iRODS), written in Go"
...
Reference MCP server for the CyVerse Data Store (iRODS), written in Go.
...
resource: <https://github.com/idss-mesa/irods-mcp-server>. Organization: <https://github.com/idss-mesa>.
