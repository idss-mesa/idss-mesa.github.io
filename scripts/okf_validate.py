#!/usr/bin/env python3
"""Validate the okf/ bundle of idss-mesa.github.io against Open Knowledge Format (OKF) v0.2 conformance.

Identical logic to the UNM-CARC/docs and neon-mcp validators (the reference OKF
...
Usage: python scripts/okf_validate.py okf      (from the repository root)
